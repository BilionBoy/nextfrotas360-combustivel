              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Valor transacionado nos últimos 5 meses
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-80">
              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Comissões geradas pela plataforma
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-80">
          ...
          <TabsContent value="postos" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Visualize e gerencie todos os postos de combustível
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex justify-center items-center h-64 text-muted-foreground">
        ...
        >
          <Card className="cursor-pointer hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Configure taxas e comissões da plataforma
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="cursor-pointer hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Gerencie pagamentos e antecipações
              </CardDescription>
            </CardHeader>
            <CardContent>
